...
const emailTranslations = {
  pl: {
    ...
    courier: 'Kurier:',
    fulfillmentTime: '⏰ Czas realizacji: 5-10 dni roboczych od momentu złożenia zamówienia. Wszystkie produkty są sprowadzane z EU oraz US.',
    whatNext: 'Co Dalej?',
  ...
  en: {
    ...
    courier: 'Courier:',
    fulfillmentTime: '⏰ Fulfillment time: 5-10 business days from order placement. All products are sourced from EU and US.',
